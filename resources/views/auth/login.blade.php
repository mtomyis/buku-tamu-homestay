...
<head>
    ...
    <!-- Favicons -->
    <link href="vendor/admin//img/logo1.png" rel="icon">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg mt-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none text-center"></div>
                            <img src="vendor/admin/img/logo1.png" width="400" height="400" alt="">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Log In!</h1>
                                        <h5>Sistem Buku Tamu Homestay Java Turtle</h5>
                                    </div>
